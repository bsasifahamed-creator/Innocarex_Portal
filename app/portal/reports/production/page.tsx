...
export default function ProductionReportPage() {
  return (
    <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-900/60 p-6">
      <h2 className="text-lg font-extrabold font-display text-slate-900 dark:text-white">Production Report</h2>
      <p className="text-slate-600 dark:text-slate-300 mt-2">
        This report will be generated from persisted quotes and policies (database-backed).
      </p>
